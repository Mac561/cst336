...
function displayAllProducts(){
    ...
    foreach ($records as $record) {
        echo "<a class='btn btn-primary' role='button' href='updateProduct.php?productId=".$record['id']."'>Update</a>";
        // echo "[<a href='deleteProduct.php?productId=".$record['id']."'>Delete</a>]";
        ...
        href='productInfo.php?productId=".$record['id']."'>".$record['name']."</a>]  ";
        ...
        if(isset($_GET['searchForm'])){
            ...
            if(isset($_GET['searchFor'])){
                ...
                foreach($records as $record){
                    ...
                    //Display Items
                    echo "<tr>";
                    echo "<td><a href='ipInfo.php?itemId=".$record['id']."'><img src='$itemImage'></td>";
                    echo "<td><a href='ipInfo.php?itemId=".$record['id']."'>".$record['name']."</a></td>  ";
