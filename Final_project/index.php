    ...
    <body>
        <h2> online Store!!!</h2>
            <ul>
                ...
                <li><a href="Lin.php">Admin</a></li>
                <!--<li><a href = "explanation.php">Explanation</a></li>-->
            </ul>
            <br> <br>
            <form method = "GET" id="forms">
            <b>  Search Movie: </b><input type="text" name="MovieName" placeholder="name" value = '<?php echo ($_GET['searchFor'] == 'movie') ?  /*$_GET['MovieName'] */ : ''; ?>'/> <br />
            <br>
            <b>Movies</b> <input type="radio" name="searchFor" value="movies" <?php echo ($_GET['searchFor'] == 'movie') ? 'checked="checked"' : ''; ?>>
            <!--<b>Video Games</b><input type="radio" name="searchFor" value="video_games"  /*echo ($_GET['searchFor'] == 'video_games') ? 'checked="checked"' : ''; ?>><br>-->
            <br>
            <b> Genre:</b> 
            <select name="genre">
